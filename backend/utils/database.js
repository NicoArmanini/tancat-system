 ...
 * Descripción: Configuración y conexión a la base de datos Neon/PostgreSQL
 */
...
// Priorizar DATABASE_URL si está disponible (método recomendado para Neon)
if (process.env.DATABASE_URL) {
    ...
    console.log('🔗 Configurando conexión con DATABASE_URL (Neon)');
} else {
    ...
    console.log('🔗 Configurando conexión con variables individuales');
}
...
async function query(text, params = []) {
    ...
    try {
        ...
        // Log de todas las consultas si está habilitado
        if (process.env.LOG_SQL_QUERIES === 'true' && process.env.NODE_ENV === 'development') {
...
function handleDbError(error) {
    ...
    switch (error.code) {
        ...
        case '42703':
            ...
            break;
        case '28P01':
            dbError.friendlyMessage = 'Error de autenticación de base de datos';
            break;
        case '3D000':
            dbError.friendlyMessage = 'Base de datos no existe';
            break;
        case '08006':
            dbError.friendlyMessage = 'Error de conexión a la base de datos';
            break;
        default:
